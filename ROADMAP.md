...
- not a promise that every idea will ship
- not a maintainer working notebook
- not a substitute for issues, validation, or release notes

If you want one of these areas to move sooner, open an issue and show the smallest proof-bearing improvement you have in mind.
