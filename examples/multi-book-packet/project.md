...
- `project_name`: Demo Multi-Book Packet
...
- `out_of_scope_sources`: all other sources, including any unimported local BYOS material
- `source_boundary_notes`: this packet is built from two open demo sources only; it does not rely on unseen private texts
